...
def get_llm_provider(config: Dict[str, Any]) -> str:
    ...
    Returns:
        String with provider name: 'api-endpoint' or 'azure-openai'
    """
    llm_config = config.get('llm', {})
    provider = llm_config.get('provider', 'api-endpoint')
...
def get_azure_openai_config(config: Dict[str, Any]) -> Dict[str, Any]:
    """Get Azure OpenAI configuration"""
    return config.get('azure-openai', {
        'api_key': None,
        'azure_endpoint': None,
