...
class LLMReranker:
    def __init__(self, model_name: str = "llama-3.3-70b-versatile", api_key: str = None):
        ...
        """
        self.api_key = api_key or "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"
