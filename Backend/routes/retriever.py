...
def retrieve(query: str = Query(...),
             ...
             rerankerOption: str = Query("none", description="Reranker option to use")):
    results = retrieve_documents(query,query_optimizer,embedding_model_name,llm_model_name, vector_db, file_id,temperature,token_size,sources,guardrailOption,rerankerOption)
